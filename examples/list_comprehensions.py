...
if __name__ == "__main__":
    print(
        "Benchmarking conditional loop vs list comprehension vs generator expression:"
    )
    benchmark_conditional_loop()
    print(
        "Benchmarking sum with traditional loop vs list comprehension vs generator expression:"
    )
    benchmark_sum()
